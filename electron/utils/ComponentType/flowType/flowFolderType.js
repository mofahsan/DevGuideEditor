...
exports.FlowFolderType = void 0;
var folderTypeEditable_1 = require("../../folderTypeEditable");
var yamlUtils_1 = require("../../yamlUtils");
var flowFileType_1 = require("./flowFileType");
var FlowFolderType = /** @class */ (function (_super) {
    __extends(FlowFolderType, _super);
    function FlowFolderType(path, name) {
        var _this = _super.call(this, path, name) || this;
        _this.allowedList = [flowFileType_1.FlowFileType.REGISTER_ID];
        return _this;
    }
    FlowFolderType.prototype.add = function (newEditable) {
        return __awaiter(this, void 0, void 0, function () {
            var addedChild;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _super.prototype.add.call(this, newEditable)];
                    case 1:
                        _a.sent();
                        addedChild = this.childrenEditables.find(function (s) { return s.name === newEditable.name; });
                        return [4 /*yield*/, (0, yamlUtils_1.updateYamlRefFlow)(this.yamlPathLong, addedChild.name)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    FlowFolderType.prototype.getData = function (query) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    FlowFolderType.prototype.remove = function (deleteTarget) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FlowFolderType.prototype.update = function (update) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    FlowFolderType.prototype.getRegisterID = function () {
        return FlowFolderType.REGISTER_ID;
    };
    FlowFolderType.REGISTER_ID = "FLOW_FOLDER";
    return FlowFolderType;
}(folderTypeEditable_1.folderTypeEditable));
exports.FlowFolderType = FlowFolderType;
