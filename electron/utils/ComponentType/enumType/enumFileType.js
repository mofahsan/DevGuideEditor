...
var EnumFileType = /** @class */ (function (_super) {
    __extends(EnumFileType, _super);
    function EnumFileType(path, name) {
        return _super.call(this, path, name) || this;
    }
    EnumFileType.prototype.getRegisterID = function () {
        return EnumFileType.REGISTER_ID;
    };
    EnumFileType.prototype.getData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = enumUtils_1.enumsFromApi;
    ...
    EnumFileType.prototype.add = function (dataToAdd) {
        return __awaiter(this, void 0, void 0, function () {
            var key, _i, _a, data_1, data, newData, yml;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        for (key in dataToAdd) {
                            for (_i = 0, _a = dataToAdd[key]; _i < _a.length; _i++) {
                                data_1 = _a[_i];
                                data_1.enums.forEach(function (e) {
                                    if (!e.reference) {
                    ...
                    case 1:
                        data = _b.sent();
                        newData = (0, enumUtils_1.mergeEnumObjectRecords)(data, dataToAdd);
                        console.log(newData);
                        yml = (0, enumUtils_1.enumsToNestes)(newData);
    ...
    EnumFileType.prototype.remove = function (dataToDel) {
        return __awaiter(this, void 0, void 0, function () {
            var data, _loop_1, key, yml;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        yml = (0, enumUtils_1.enumsToNestes)(data);
                        return [4 /*yield*/, (0, yamlUtils_1.overrideYaml)(this.yamlPathLong, (0, yamlRefConvert_1.convertToYamlWithRefs)(yml))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
    ...
    EnumFileType.prototype.update = function (dataToUp) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent();
                        if (dataToUp.hasOwnProperty("oldName") &&
                            ...
                            _loop_2 = function (key) {
                                if (data.hasOwnProperty(key)) {
                                    data[key] = data[key].map(function (d) {
                                        var updated = dataToUp[key].find(function (u) { return u.path === d.path; });
    ...
    EnumFileType.REGISTER_ID = "ENUM_FILE";
    return EnumFileType;
}(FileTypeEditable_1.FileTypeEditable));
exports.EnumFileType = EnumFileType;
