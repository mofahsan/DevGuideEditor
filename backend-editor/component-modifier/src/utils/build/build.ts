...
// var flow_set = args[1]
var base_yaml = isBinary? path.join(rootPath,"../","FORKED_REPO/api/components/beckn_yaml.yaml"): "./src/utils/build/beckn_yaml.yaml"; //beckn yaml
var example_yaml = isBinary? path.join(rootPath,"../","FORKED_REPO/api/components/index.yaml"):"../FORKED_REPO/api/components/index.yaml"; //args[1]; //  main file of the yamls
var outputPath = isBinary? path.join(rootPath,"../", "FORKED_REPO/api/build/build.yaml") : "./src/build/build.yaml";
var uiPath = isBinary? path.join(rootPath,"../", "FORKED_REPO/ui/build.js") : "./src/build/build.js";
...
export async function buildWrapper(folderName) {
  try {
    ...
    compareFiles();
    if(folderName){
      var example_yaml = isBinary? path.join(rootPath,"../",`FORKED_REPO/api/${folderName}/index.yaml`):`../FORKED_REPO/api/${folderName}/index.yaml`; //args[1]; //  main file of the yamls
    }
